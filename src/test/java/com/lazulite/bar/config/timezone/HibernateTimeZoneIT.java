package com.lazulite.bar.config.timezone;

import com.lazulite.bar.BarApp;
import com.lazulite.bar.config.SecurityBeanOverrideConfiguration;
import com.lazulite.bar.repository.timezone.DateTimeWrapper;
import com.lazulite.bar.repository.timezone.DateTimeWrapperRepository;
 ...
 */
@SpringBootTest(classes = {SecurityBeanOverrideConfiguration.class, BarApp.class})
